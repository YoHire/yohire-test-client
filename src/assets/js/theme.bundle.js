  ...
  var e,
    t = {
      ...
      524: (e, t, a) => {
        ...
        f().registerLanguage("xml", y()),
          f().registerLanguage("javascript", h()),
          k.forEach((e) => {
            f().highlightBlock(e);
          }),
          (window.hljs = f());
        ...
        const L = document.querySelectorAll(".kanban-category"),
          S = document.querySelectorAll(".kanban-add-link"),
        ...
        function $(e) {
          const { chart: t, tooltip: a } = e,
            n = (function (e) {
              ...
              if (!t) {
                ...
                n.classList.add("popover-content"),
                  t.appendChild(a),
                  t.appendChild(n),
          ...
          (n.style.visibility = "visible"),
            (n.style.left = o + a.caretX + "px"),
            (n.style.top = l + a.caretY + "px"),
            (n.style.transform =
        ...
        (I.kL.defaults.responsive = !0),
          ...
          (I.kL.defaults.plugins.tooltip.external = $),
          (I.kL.defaults.plugins.tooltip.callbacks.label = j),
    ...
    (n.O = (t, a, o, l) => {
      if (!a) {
        ...
        for (d = 0; d < e.length; d++) {
          for (var [a, o, l] = e[d], s = !0, c = 0; c < a.length; c++)
            (!1 & l || r >= l) && Object.keys(n.O).every((e) => n.O[e](a[c]))
              ? a.splice(c--, 1)
              : ((s = !1), l < r && (r = l));
          if (s) {
            e.splice(d--, 1);
